    ...
    return (
      <div className="flex flex-col items-center justify-center h-[70vh] text-center space-y-6">
        ...
        <div className="animate-in fade-in zoom-in-95">
          <h3 className="text-3xl font-black uppercase tracking-tighter text-dd-dark">Processing Deal</h3>
          <p className="text-dd-muted font-bold text-sm uppercase tracking-widest mt-2">Confirming with {bid.agentName}...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-right-6 duration-500 pb-10">
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-3xl font-black tracking-tighter uppercase text-dd-dark">MunchMatch Review</h2>
      </div>

      <div className="bg-white rounded-[2.5rem] p-8 border-2 border-dd-light shadow-2xl shadow-black/5">
        <h3 className="text-[10px] font-black uppercase text-dd-muted mb-5 tracking-[0.2em]">Order Summary</h3>
        <div className="space-y-5 mb-8">
          <div className="flex justify-between items-start">
            <div className="flex-1 pr-6">
              <span className="text-lg font-black block leading-none mb-1 uppercase tracking-tight text-dd-dark">{bid.agentName}</span>
          ...
          <div className="space-y-2 pt-5 border-t border-dd-light">
            <div className="flex justify-between items-center text-xs font-bold text-dd-muted">
              <span className="uppercase tracking-widest font-black">Delivery (Boston Area)</span>
              <span className="text-dd-orange font-black uppercase tracking-widest">Match Promo: $0.00</span>
            </div>
            <div className="flex justify-between items-center text-xs font-bold text-dd-muted">
      ...
      <div className="space-y-6 px-2">
        ...
        <div>
          <label className="block text-[10px] font-black uppercase text-dd-muted mb-3 tracking-[0.2em]">Payment Method</label>
          <div className="bg-dd-dark text-white p-8 rounded-[2rem] font-mono relative overflow-hidden shadow-2xl">
            ...
            <div className="text-[10px] mb-6 opacity-40 font-black tracking-[0.3em] uppercase">MunchMatch Terminal</div>
            ...
            <div className="flex justify-between text-[11px] items-end">
              ...
              <div>
                <div className="opacity-40 text-[8px] uppercase font-black mb-1">CVV</div>
