  ...
  return (
    <header className="p-4 border-b border-dd-light flex items-center justify-between sticky top-0 bg-white z-50">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h1 className="text-xl font-black tracking-tighter leading-none text-dd-dark uppercase">Grub War</h1>
          <span className="text-[10px] font-bold text-dd-orange uppercase tracking-widest">Boston Arena</span>
        </div>
      </div>
      <div className="flex flex-col items-end">
        <div className="text-[9px] font-black bg-dd-dark text-white px-2 py-0.5 rounded-full uppercase">Leadership Demo</div>
        <div className="text-[8px] font-mono text-dd-muted mt-0.5 uppercase tracking-tighter">v4.0_AGENTIC_FLOW</div>
      </div>
    </header>
  );
};
