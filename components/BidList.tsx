  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] text-center p-8">
        ...
        <h3 className="font-black text-3xl uppercase tracking-tighter italic text-dd-dark leading-none">THE MATCH ROOM</h3>
      ...
      <div className="space-y-6">
        {bids.map((bid, i) => {
          ...
          return (
            <div 
              key={i}
              className={`${theme.bg} border-4 ${theme.border} ${theme.hoverBorder} rounded-[2.5rem] overflow-hidden transition-all shadow-xl shadow-black/5 active:scale-[0.99]`}
            >
              <div className="p-7">
                <div className="flex justify-between items-start mb-6">
                  <div className="flex items-center gap-4">
                    <div className="relative">
                      <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center text-white font-black text-3xl shadow-md ring-4 ring-white/50 overflow-hidden">
                    ...
                    <div>
                      <h3 className="font-black text-xl uppercase tracking-tight leading-tight text-dd-dark">{bid.agentName}</h3>
                      <div className={`text-[10px] font-black uppercase tracking-widest mt-1 ${theme.accent}`}>
                  ...
                  <div className="text-right">
                    ...
                    <div className={`text-[8px] font-black ${theme.tagBg} text-white px-2 py-1 rounded-md uppercase tracking-widest mt-2 shadow-sm`}>BEST MATCH</div>
                  </div>
                </div>
                
                <div className={`${theme.innerBg} p-5 rounded-[1.5rem] mb-6 border border-white/50 backdrop-blur-sm`}>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`text-[10px] font-black uppercase tracking-tight ${theme.accent}`}>{bid.moat}</span>
                  </div>
                </div>
